import { extractFrontmatter, normalizeNote, NormalizedNote } from '../note';
...
describe('normalizeNote', () => {
    it('should normalize a note correctly', () => {
        ...
        expect(normalizedNote.created).toEqual(new Date('2023-05-20T10:00:00Z'));
        expect(normalizedNote.updated).toEqual(new Date('2023-05-21T11:00:00Z'));
