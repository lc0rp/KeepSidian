...
**Note:** No need to manually update the KEEPSIDIAN_SERVER_URL in `.env.production` - This is handled in the release script.
...
- Run `npm run release` after reviewing the dry run output to create the build, bump the version, and push tags.
